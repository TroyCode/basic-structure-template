...
This is a sample template for aws-sam-with-go1.x - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name aws-sam-with-go1.x --query 'Stacks[].Outputs'
```
