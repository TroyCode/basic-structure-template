...
This is a sample template for aws-sam-with-nodejs - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name aws-sam-with-nodejs \
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-sam-with-nodejs --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-sam-with-nodejs
```
