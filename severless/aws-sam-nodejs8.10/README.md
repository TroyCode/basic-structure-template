# aws-sam-with-nodejs8.10

This is a sample template for aws-sam-with-nodejs8.10 - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name aws-sam-with-nodejs8.10 \
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-sam-with-nodejs8.10 --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-sam-with-nodejs8.10
```
