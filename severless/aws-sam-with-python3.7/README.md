# aws-sam-with-python3.7

This is a sample template for aws-sam-with-python3.7 - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name aws-sam-with-python3.7 \
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-sam-with-python3.7 --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-sam-with-python3.7
```
